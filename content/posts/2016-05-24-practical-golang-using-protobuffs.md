...
<pre><code class="proto">message Client {
...
<pre><code class="proto">type name = id;
</code></pre>
...
<pre><code class="proto">        string country = 4;
...
<pre><code class="proto">        message Mail {
                string remoteEmail = 1;
                string body = 2;
        }
...
<pre><code class="go">// Code generated by protoc-gen-go.
...
<pre><code class="go">http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
        myClient := Client{}
...
<pre><code class="go">        if err := proto.Unmarshal(data, &myClient); err != nil {
            fmt.Println(err)
        }
...
<pre><code class="go">    myClient.Inbox = clientInbox
